...
<body class="hold-transition sidebar-mini">
	<div class="wrapper" id="app">
				...
				<li class="nav-item dropdown">
					<a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button"
						...
						@if(Auth::user()->instructor->profile_image != null)
							<img src="{{ asset('storage/' . Auth::user()->instructor->profile_image) }}" class="img-circle elevation-1" alt="User Image" width="35" height="35">
						@else
					...
					<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
						<div class="dropdown-item">
							...
							<hr>
						<!-- my profile-->
						<a class="dropdown-item" href="{{ route('instructor-profile.show', ['user' => Auth::user()]) }}">
		...
		@include('front-instructor.layouts.mainsidebar')
