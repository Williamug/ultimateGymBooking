			...
			<div class="card-body row">
				<div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('title') is-invalid @enderror" name="title" id="title" placeholder="Enter title">
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('price') is-invalid @enderror" name="price" id="price" placeholder="Enter price">
                    @error('price')
						<div class="error-alert">{{ $message }}</div>
					@enderror
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm @error('available_seats') is-invalid @enderror" name="available_seats" id="available_seats" placeholder="Enter available seats">
                ...
                <!-- instructor -->
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" placeholder="Enter service description" name="description"></textarea>
                  </div>
                  <!-- /.description-->
                  <div class="row">
                  	<div class="col-2">
				...
				<div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control form-control-sm @error('service_starts_at') is-invalid @enderror" name="service_starts_at" id="service_starts_at" placeholder="hh:mm:ss">
                  ...
                  <div class="form-group">
                    ...
                    <input type="time" class="form-control form-control-sm @error('service_ends_at') is-invalid @enderror" name="service_ends_at" id="service_ends_at" placeholder="hh:mm:ss">
