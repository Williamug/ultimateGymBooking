...
@section('content')
	...
	<div class="card">
      			...
      			<div class="col-7">
					...
					<div class="row">
						...
						<div class="col-6">
							...
							<p>{{ $service->days }}</p>
							<p>{{ $service->price }}</p>
							<p>{{ $service->description === null ? 'No description for this service' : $service->description }}</p>
							<p>
      ...
      <div class="row">
      	<div class="col-2">
      		<a href="{{ route('services.edit', ['service' => $service]) }}" class="btn bg-gradient-primary btn-sm"><i class="fas fa-pen"></i> Edit</a>
      	</div>
      	<div class="col-6">
